...
/**
 * Tests the class {@link ResponseBuilder}.
 */
public class ResponseBuilderTest {
    ...
    public void build_withDateTimeAndWithTextContent_returnsResponseWithContent() {
        ...
        final ZonedDateTime dateTime = ZonedDateTime.of(2017, 3, 20, 19, 9, 3, 40, ZoneId.of("GMT"));
        final ResponseBuilder httpResponse = ResponseBuilder
                .createWithStatus(StatusCode.OK)
                .dateTime(dateTime)
    ...
    public void build_withoutDateTime_returnsResponseWithCurrentDateTime() {
        final ResponseBuilder httpResponse = ResponseBuilder.createWithStatus(StatusCode.BAD_REQUEST);
